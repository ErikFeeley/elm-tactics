...
var _user$project$Data_User$encodeUser = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
			...
			_1: {
				...
				_0: {
					...
					_0: 'friends',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, record.friends))
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'rating',
						_1: _elm_lang$core$Json_Encode$int(record.rating)
					},
					_1: {
						ctor: '::',
						_0: {
...
var _user$project$Data_User$encodeUserResponse = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
			...
			_1: {
				...
				_0: {
					...
					_0: 'data',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Data_User$encodeUser, record.data))
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'timestamp',
						_1: _elm_lang$core$Json_Encode$string(record.timestamp)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'statusCode',
							_1: _elm_lang$core$Json_Encode$int(record.statusCode)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Data_User$UserResponse = F4(
	function (a, b, c, d) {
		return {status: a, data: b, timestamp: c, statusCode: d};
	});
var _user$project$Data_User$User = F4(
	function (a, b, c, d) {
		return {id: a, friends: b, rating: c, name: d};
	});
...
var _user$project$Data_User$decodeUserResponse = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'statusCode',
	_elm_lang$core$Json_Decode$int,
	A3(
		...
		A3(
			...
			A3(
				...
				'status',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Data_User$UserResponse)))));

var _user$project$Page_Battles$view = A2(
...
var _user$project$Route$Battles = {ctor: 'Battles'};
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Route$href(_user$project$Route$User),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _user$project$Views_Page$isActive = F2(
	function (page, route) {
		...
		if (((_p0.ctor === '_Tuple2') && (_p0._0.ctor === 'Home')) && (_p0._1.ctor === 'Home')) {
			return true;
		} else {
			return false;
		}
...
var _user$project$Views_Page$User = {ctor: 'User'};
...
var _user$project$Page_Home$init = {count: 0};
var _user$project$Page_Home$Model = function (a) {
	return {count: a};
};
var _user$project$Page_Home$Decrement = {ctor: 'Decrement'};
var _user$project$Page_Home$Increment = {ctor: 'Increment'};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Page_Home$Increment),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Page_Home$Decrement),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Request_Helpers$apiUrl = function (str) {
	return A2(_elm_lang$core$Basics_ops['++'], 'http://ec2-18-191-140-179.us-east-2.compute.amazonaws.com:13370/api', str);
};

var _user$project$Request_User$getUsers = A2(
	_elm_lang$http$Http$get,
	_user$project$Request_Helpers$apiUrl('/users'),
	_user$project$Data_User$decodeUserResponse);

var _user$project$Page_User$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Page_User$Model = function (a) {
	return {users: a};
};
var _user$project$Page_User$init = function () {
	var handleLoadError = function (_p0) {
		return A2(_user$project$Page_Errored$pageLoadError, _user$project$Views_Page$User, 'Users failed to load');
	};
	var loadUserResults = _elm_lang$http$Http$toTask(_user$project$Request_User$getUsers);
	return A2(
		_elm_lang$core$Task$mapError,
		handleLoadError,
		A2(_elm_lang$core$Task$map, _user$project$Page_User$Model, loadUserResults));
}();
...
var _user$project$Main$Battles = {ctor: 'Battles'};
...
var _user$project$Main$UserResultLoaded = function (a) {
	return {ctor: 'UserResultLoaded', _0: a};
};
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								pageState: _user$project$Main$Loaded(
									_user$project$Main$Home(_user$project$Page_Home$init))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Battles':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								pageState: _user$project$Main$Loaded(_user$project$Main$Battles)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				default:
					return A2(transition, _user$project$Main$UserResultLoaded, _user$project$Page_User$init);
			}
		}
	});
...
var _user$project$Main$viewPage = function (page) {
	...
	switch (_p3.ctor) {
		...
		default:
			return A2(
				_user$project$Views_Page$frame,
				_user$project$Views_Page$User,
				_user$project$Page_User$view(_p3._0));
	}
};
	...
	function (page, msg, model) {
		var toPage = F5(
			function (toModel, toMsg, subUpdate, subMsg, subModel) {
				var _p5 = A2(subUpdate, subMsg, subModel);
				var newModel = _p5._0;
				var newCmd = _p5._1;
				return {
					ctor: '_Tuple2',
		...
		switch (_p6._0.ctor) {
			...
			case 'HomeMsg':
				if (_p6._1.ctor === 'Home') {
					return A5(toPage, _user$project$Main$Home, _user$project$Main$HomeMsg, _user$project$Page_Home$update, _p6._0._0, _p6._1._0);
				} else {
				...
				if (_p6._0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _user$project$Main$Loaded(
									_user$project$Main$User(_p6._0._0._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _user$project$Main$Loaded(
									_user$project$Main$Errored(_p6._0._0._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _user$project$Main$main = A2(
	...
	function (_p7) {
		return _user$project$Main$SetRoute(
			_user$project$Route$fromLocation(_p7));
	},
	{
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Route.Route":{"args":[],"tags":{"Home":[],"Root":[],"User":[],"Battles":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"UserResultLoaded":["Result.Result Page.Errored.PageLoadError Page.User.Model"],"SetRoute":["Maybe.Maybe Route.Route"],"HomeMsg":["Page.Home.Msg"]}},"Page.Errored.PageLoadError":{"args":[],"tags":{"PageLoadError":["Page.Errored.Model"]}},"Views.Page.ActivePage":{"args":[],"tags":{"Other":[],"Home":[],"User":[],"Battles":[]}},"Page.Home.Msg":{"args":[],"tags":{"Decrement":[],"Increment":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Page.Errored.Model":{"args":[],"type":"{ activePage : Views.Page.ActivePage, errorMessage : String }"},"Page.User.Model":{"args":[],"type":"{ users : Data.User.UserResponse }"},"Data.User.User":{"args":[],"type":"{ id : String, friends : List String, rating : Int, name : String }"},"Data.User.UserResponse":{"args":[],"type":"{ status : String , data : List Data.User.User , timestamp : String , statusCode : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
